...
parser.add_argument("--directorio_origen", type=str, default="/content/drive/MyDrive/yolov3/data/custom/images", help="Directorio donde se encuentran todas las imagenes y las etiquetas")
